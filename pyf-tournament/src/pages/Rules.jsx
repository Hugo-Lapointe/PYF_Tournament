...
export default function Rules() {
  return (
    ...
    >
        ...
        <h1 className="text-4xl font-extrabold mb-10 text-center max-w-xl">
        ...
        <div className="w-full max-w-3xl space-y-8">
            ...
            <p className="font-semibold mb-2">Point System:</p>
            <List items={[
                "Win (any kind) = 2 points",
                "Loss in Overtime = 1 point",
                "Loss in Regulation = 0 points"
            ]} />
            <p className="font-semibold mb-2 mt-6">Tiebreakers (in order):</p>
            <List items={[
            ...
            <p className="font-semibold mb-2">Map Selection Process:</p>
            <List items={[
            ...
            <p className="font-semibold mb-2 mt-6">Lobby Setup:</p>
            <List items={[
            ...
            <p className="font-semibold mb-2 mt-6">Disconnects / Tech Issues:</p>
            <List items={[
